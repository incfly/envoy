...
public:
  ...
  createNetworkFilterChain(Network::Connection& connection,
                           const std::vector<Network::NetworkFilterFactoryCb>& factories) override;
...
private:
  void addFilterChain(const std::string& transport_socket_name,
  ...
  std::vector<std::vector<Network::NetworkFilterFactoryCb>> filter_factories_;
...
public:
  ...
  const std::vector<Network::NetworkFilterFactoryCb>& getNetworkFilterFactories() const {
    return filters_factory_;
  }

private:
  const Network::TransportSocketFactoryPtr transport_socket_factory_;
  const std::vector<Network::NetworkFilterFactoryCb> filters_factory_;
};
